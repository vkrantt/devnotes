...
const SuggestionCard = () => {
  return (
    <div className='d-flex align-items-center justify-content-between gap-3 bg-white my-2 p-2'>
        <img className="rounded-pill border-3 border-blue" src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-profiles/avatar-1.webp" style={{width: '50px', height: '50px'}}/>
        <div className='pt-3'>
